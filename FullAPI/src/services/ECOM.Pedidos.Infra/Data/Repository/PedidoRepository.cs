...
namespace ECOM.Pedidos.Infra.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        public async Task<PedidoItem> ObterItemPorPedido(Guid pedidoId, Guid productId)
        {
            return await _context.PedidoItems
                .FirstOrDefaultAsync(p => p.ProductId == productId && p.PedidoId == pedidoId);
        }      
